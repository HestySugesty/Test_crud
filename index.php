		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
                    ...
                    <br/>
                    <span style="color:#fff";>Selamat Datang, <?php echo $sesi['name'];?></span>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            <a onclick="return confirm('Apakah yakin data akan di hapus?')" href="proses/crud.php?aksi=hapus&hapusid=<?php echo $isi['id'];?>" 
